...
class DocumentCell extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pointer: 0,
      imgs: [Images.imgMan6, Images.imgMan7, Images.imgMan8, Images.imgMan4, Images.imgMan5, Images.imgMan9, Images.imgMan6, Images.imgMan7, Images.imgMan4 ],
        ...
        <View style={[styles.container, Styles.rowContainer, { marginVertical: 10 }]}>
          ...
          <View style={{ flex: 1, justifyContent: 'center' }}>
            ...
            <View style={{ ...Styles.rowContainer }}>
              ...
              <View style={{ flex: 1 }}>
                {/*<Text style={{ ...Fonts.style.h6, alignSelf: 'flex-end', color:this.state.States[this.props.id.key] != false ? Colors.textSecondary : "#00FF00" }}>{this.state.States[this.props.id.key] != false ? "Checked out" : "Checked in"}</Text>*/}
              </View>
            </View>
