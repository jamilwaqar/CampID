...
class Login extends Component {
  ...
  doLogin() {
    ...
    setTimeout(() => {
      ...
      this.props.replaceRoute('select');
    }, 1300);
  }
        ...
        <View style={Styles.fullScreen}>
          ...
          <View style={styles.bodyContainer}>
            ...
            <View
              ...
              { borderColor: Utils.getTextInputBorderColor(this.state.emailFocus),flexDirection: 'row' }]}>
              <Icon name="user" size={19} color={Colors.textPlaceholder} style={{position: 'relative', top: 8, marginRight: 8, height: 20}}/>
              <TextInput
            ...
            <View
              style={[Styles.textInputContainerStyle,
              { borderColor: Utils.getTextInputBorderColor(this.state.passwordFocus),flexDirection: 'row' }]}>
              <Icon name="lock" size={20} color={Colors.textPlaceholder} style={{position: 'relative', top: 8, marginRight: 8, height: 20}}/>
              <TextInput
          ...
          {/* -----BottomArea---- */}
          <View style={[styles.bottomAreaLogin, { alignSelf: 'flex-end', top: -12 }]}>
