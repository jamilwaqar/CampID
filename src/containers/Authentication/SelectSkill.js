...
class RegisterSkill extends Component {
  ...
  onBtnFocus(value) {
    ...
    switch(value){
      case "beginner":
        mstate = !this.state.beginnerFocus;
        this.setState({beginnerFocus:mstate});
        break;
      case "novice":
        mstate = !this.state.noviceFocus;
        this.setState({noviceFocus:mstate});
        break;
      case "intermediate":
        mstate = !this.state.intermediateFocus;
        this.setState({intermediateFocus:mstate});
        break;
      case "advanced":
        mstate = !this.state.advancedFocus;
        this.setState({advancedFocus:mstate});
        break;
      case "elite":
        mstate = !this.state.eliteFocus;
        this.setState({eliteFocus:mstate});
        break;
      default:
        break;
    }
    //this.setState({ beginnerFocus: false, noviceFocus: false, intermediateFocus: false, advancedFocus: false, eliteFocus: false });
    //this.setState({ [`${value}Focus`]: this.state.[`${value}Focus`] });
  }
          ...
          <Image
            ...
            <View style={{ flex: 9, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1, alignItems: 'flex-end' }} >
                {CommonWidgets.renderImgBtn( () => this.props.pushNewRoute('selectExp'), { marginRight: Metrics.bottomBtnMargin }, Images.imgRightBtn)}
              </View>
            </View>
            <View style={{ flex: 5 }} />
          </Image>
