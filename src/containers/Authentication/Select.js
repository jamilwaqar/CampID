      ...
      <KeyboardAwareScrollView
        ...
        <View style={Styles.fullScreen}>
          ...
          <NavigationBar
            ...
            title={CommonWidgets.renderNavBarHeader('Johnathan Thomas')}
          ...
          <Image
            ...
            <View style={{ flex: 9, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1, alignItems: 'flex-end' }} >
                {CommonWidgets.renderImgBtn( () => this.props.pushNewRoute('selectSkill'), { marginRight: Metrics.bottomBtnMargin }, Images.imgRightBtn)}
              </View>
            </View>
            <View style={{ flex: 5 }} />
          </Image>
