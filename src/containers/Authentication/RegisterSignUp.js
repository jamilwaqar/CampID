        ...
        <View style={{...Styles.fullScreen}} >
              ...
              <View style={{...Styles.fullScreen, height: Metrics.screenHight * 0.6, alignItems:"center"}} >  
                <View style={[styles.signUp,{ height: Metrics.screenHeight * 0.75, alignItems:"flex-start"}]}>
                  ...
                  <View
                    ...
                    { borderColor: Utils.getTextInputBorderColor(this.state.firstNameFocus),flexDirection: 'row' }]}>
                    <TextInput
                  ...
                  <View
                    style={[Styles.textInputContainerStyle,
                    { borderColor: Utils.getTextInputBorderColor(this.state.lastNameFocus),flexDirection: 'row' }]}>
                    <TextInput
                      style={Styles.textInputStyle}
                      underlineColorAndroid={'transparent'}
                  ...
                  <View
                    style={[Styles.textInputContainerStyle,
                    { borderColor: Utils.getTextInputBorderColor(this.state.emailAddressFocus),flexDirection: 'row' }]}>
                    <TextInput
                      style={Styles.textInputStyle}
                      underlineColorAndroid={'transparent'}
                  ...
                  <View
                    style={[Styles.textInputContainerStyle,
                    { borderColor: Utils.getTextInputBorderColor(this.state.genderFocus), alignItems:"center", flexDirection: 'row', width:Metrics.screenWidth * 0.4 }]}>
                    <TextInput
                      style={Styles.textInputStyle}
                      underlineColorAndroid={'transparent'}
                      placeholder={"Gender"}
                      placeholderTextColor={Colors.textPlaceholder}
                      multiline={false}
                      onFocus={() => this.onTextInputFocus('gender')} />
                    <Icon name="chevron-down" size={17} color={Colors.textPlaceholder} style={{left: -180, top: 0, backgroundColor:Colors.brandThird}} />
                  </View>
                  ...
                  <View
                    style={[Styles.textInputContainerStyle,
                    { borderColor: Utils.getTextInputBorderColor(this.state.birthdayFocus),alignItems:"center", flexDirection: 'row' , width:Metrics.screenWidth * 0.6}]}>
                    <TextInput
                      style={Styles.textInputStyle}
                      underlineColorAndroid={'transparent'}
                      ...
                      placeholderTextColor={Colors.textPlaceholder}
                      multiline={false}
                      onFocus={() => this.onTextInputFocus('birthday')} />
                    <Icon name="calendar" size={17} color={Colors.textPlaceholder} style={{left: -110, top: 0, backgroundColor:Colors.brandThird}} />
                  </View>
                  ...
                  <View style={{flexDirection : "row"}}>
                    <View
                      style={[Styles.textInputContainerStyle,
                      { borderColor: Utils.getTextInputBorderColor(this.state.phoneNumberFocus),flexDirection: 'row', width:Metrics.screenWidth * 0.44 }]}>
                      <TextInput
                        style={Styles.textInputStyle}
                        underlineColorAndroid={'transparent'}
                        ...
                        placeholderTextColor={Colors.textPlaceholder}
                        multiline={false}
                        onFocus={() => this.onTextInputFocus('phoneNumber')} />
                    </View>
          ...
          <View style={{ flex: 9, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1, alignItems: 'flex-end' }} >
                {CommonWidgets.renderImgBtn(() => this.props.pushNewRoute('registerSignUpDetail'), { marginRight: Metrics.bottomBtnMargin }, Images.imgRightBtn)}
              </View>
          </View>
          <View style={{ flex: 5 }} />
