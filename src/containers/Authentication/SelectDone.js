...
class SelectDone extends Component {
  constructor(props) {
    super(props);
    this.state = {
      athleteFocus: false,
        ...
        <View style={Styles.fullScreen}>
          ...
          <Image
            ...
            <View style={{ flex: 15 }}>
              ...
              {CommonWidgets.renderTextWithMargin(Fonts.style.h4, 'Upgrade')}
              {CommonWidgets.renderTextWithMargin({ ...Fonts.style.h6, ...Fonts.style.regular }, 'Lorem ipsum dolor sit arnet, consectetur adipiscing elit.lla empor feugiat elementumaecenas rhmale.')}
            </View>
            <View style={[{ flex: 18 }, Styles.center]}>
              {CommonWidgets.renderMaterialButton(I18n.t('SUBSCRIBE_TO_CAMPID'), Colors.brandPrimary)}
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectDone);