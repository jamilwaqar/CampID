          ...
          {/* -----Avatar---- */}
            ...
            <View style={{flex: 9, flexDirection: 'row'}}>
              ...
              <View style={{flex:1, alignItems:'flex-end'}} >
                {CommonWidgets.renderImgBtn( () => this.props.pushNewRoute('selectDone'), {marginRight: Metrics.bottomBtnMargin},Images.imgRightBtn)}
              </View>
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectExp);