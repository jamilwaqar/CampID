      ...
      <KeyboardAwareScrollView
        ...
        <View style={Styles.fullScreen}>
          ...
          <Image
            ...
            <View style={{ flex: 26 }}>
              {CommonWidgets.renderSpacer(230)}
              {CommonWidgets.renderBigText(I18n.t('SELECTPROFILE'))}
            </View>
            ...
            <View style={{ flex: 9, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1, alignItems: 'flex-end' }} >
                {CommonWidgets.renderImgBtn(() => this.props.pushNewRoute('registerSignUp'), { marginRight: Metrics.bottomBtnMargin }, Images.imgRightBtn)}
              </View>
            </View>
            <View style={{ flex: 5 }} />
          </Image>
