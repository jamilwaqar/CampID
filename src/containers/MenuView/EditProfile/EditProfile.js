      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          <ScrollView>
            <View style={[Styles.container, { flexDirection: 'row' }]} >
              <View style={{ width: 100 }}>
                {CommonWidgets.renderAvatar(Images.imgMan3, null, 1)}
              </View>
              <View style={{ flex: 1, flexDirection: 'column' }}>
                ...
                <View style={styles.profileRow}>
                  ...
                  <Text style={styles.normalBrandText}>High School</Text>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('SCHOOL')}</Text>
                  <Text style={styles.normalBrandText}>Saint Francis(GA)</Text>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('SPORTS')}</Text>
                  <View>
                    <Text style={styles.normalBrandText}>W Baskball</Text>
                    <Text style={styles.normalBrandText}>Lacrose</Text>
                    <Text style={styles.normalBrandText}>Add New</Text>
                  </View>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('NUMBERS')}</Text>
                  <Text style={styles.normalBrandText}>#1(wb), #21(lax)</Text>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('HEIGHT')}</Text>
                  <Text style={styles.normalBrandText}>5'9</Text>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('WEIGHT')}</Text>
                  <Text style={styles.normalBrandText}>145 lbs</Text>
                </View>
                <View style={styles.profileRow}>
                  <Text style={styles.normalText}>{I18n.t('LOCATION')}</Text>
                  <Text style={styles.normalBrandText}>Alpharetta, GA</Text>
                </View>
              </View>
            </View>
          </ScrollView>
        ...
        <View style={Styles.container} >
          ...
          <View style={{ flexDirection: 'row' }}>
            {CommonWidgets.renderMaterialButton(I18n.t('ATHLETE'), Utils.getNormalBtnBackcolor(this.state.athleteFocus), () => this.onAccountFocus('athlete'), 80, 33, 13)}
            {CommonWidgets.renderMaterialButton(I18n.t('COACH'), Utils.getNormalBtnBackcolor(this.state.coachFocus), () => this.onAccountFocus('coach'), 70, 33, 13)}
            {CommonWidgets.renderMaterialButton(I18n.t('ADMINISTRATOR'), Utils.getNormalBtnBackcolor(this.state.administratorFocus), () => this.onAccountFocus('administrator'), 110, 33, 13)}
            {CommonWidgets.renderMaterialButton(I18n.t('PARENT'), Utils.getNormalBtnBackcolor(this.state.parentFocus), () => this.onAccountFocus('parent'), 70, 33, 13)}
          </View>
          {CommonWidgets.renderSpacer(30)}
          <Text style={styles.normalText}>
            {I18n.t('SKILL_LEVEL')}
